      ...
      <div>
        ...
        <div className="relative mt-2 rounded-md shadow-sm">
          ...
          <input
            ...
            name="height"
            id="height"
            className="block w-full rounded-md border-0 py-1.5 pl-5 pr-2 text-gray-900 outline-none ring-1 ring-inset ring-gray-300 placeholder:text-gray-400 focus:ring-2 focus:ring-inset focus:ring-cyan-500 sm:text-sm sm:leading-6"
            placeholder="0.00"
